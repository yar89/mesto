export class Card {
    ...
    generateCard(){
      ...
      this._deliteButtonElement = this._element.querySelector('.card__delite-button');
    ...
    _deliteCard(event) {
      this._deliteButtonElement = event.target.closest('.card');
      this._deliteButtonElement.remove();
    ...
    _setEventListeners() {
      ...
      this._deliteButtonElement.addEventListener('click', (event) => {
        this._deliteCard(event);
      });
